        ...
        <table style="width:1020px;font-size:9pt">
          <thead>
            <tr>
              ...
              <th>К оплате<br/>ставка<br/>простой<br/>переадр<br/>абон. плата</th>
              <th>Дата оплаты</th>
              <th>Срок оплаты</th>
              <th>Долг</th>
              <th>Платежи<br/>дата, сумма, №</th>
            </tr>
          </thead>
          <tbody>
          <g:each in="${searchresult.records}" status="i" var="record">
            ...
            <tr><td colspan="2"></td><td colspan="2">СУММА ОПЛАЧЕННОЙ АБОНЕНТСКОЙ ПЛАТЫ</td><td>${taxsum}</td><td colspan="6"></td></tr>
            <tr><td colspan="2"></td><td colspan="2">ИТОГО ПОЕЗДОК</td><td>${searchresult.records?.size()?:0}</td><td colspan="6"></td></tr>
            <tr><td colspan="2"></td><td colspan="2">ИТОГО ОБОРОТ</td><td>${pricesum}</td><td colspan="6"></td></tr>
            <tr><td colspan="2"></td><td colspan="2">ИТОГО ПОЛУЧЕНО</td><td>${paidsum}</td><td colspan="6"></td></tr>
