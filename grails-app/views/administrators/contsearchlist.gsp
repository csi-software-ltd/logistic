<div id="ajax_wrap">
  <div style="padding:10px">
    ...
    <div class="fright">
      <g:paginate controller="administrators" action="${actionName}" params="${[cont:cont]}" 
    ...
    <table class="list" width="100%" cellpadding="0" cellspacing="0" border="0">
      ...
      <g:each in="${searchresult.records}" status="i" var="record">
        <tr align="center" style="font-size:11px;line-height:15px">
          <td><g:link action="orderdetail" id="${record.zakaz_id}">${record.zakaz_id}</g:link></td>
          <td><g:link action="tripdetail" id="${record.id}">${record.id}</g:link></td>
          <td><g:if test="${record.payorder_id>0}"><g:link action="findetail" id="${record.payorder_id}">${record.norder}</g:link></g:if><g:else>нет</g:else></td>
          ...
          <td align="left" nowrap>
            ...
            Телефон вод.: &nbsp;<font color="#0E66C8">${record.tel}</font><br/>
